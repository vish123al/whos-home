...
<body>
  ...
  <div class="container">
   ...
   <img src="img/header/50Elogo_final.png" alt="SSC PAC 50E Logo" style="width:110px;height:75px;" align="right">
    ...
    <article>
      ...
      <!-- This page will give the user a chance to will in the information for a BlueTooth device to register, as well as identifying all currently registered BlueTooth MAC -->
  ...
  $query = "SELECT * from UserMACs"; // query to pull all currently registered BlueTooth MAC devices
  $rs = mysql_query($query);

    // create a table of all registered Bluetooth devices and MAC addresses
  echo "<table> <tr> <th> MAC Address </th> <th> Registered Name </th> </tr>";   // create the table and heading row

  while ($row = mysql_fetch_assoc($rs)) {
      echo "<tr> <td>" . $row['MAC'] . "</td> <td>" . $row['User'] . "</td></tr>";  // create a line per response
  }
